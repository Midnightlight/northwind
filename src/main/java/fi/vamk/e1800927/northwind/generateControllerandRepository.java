package fi.vamk.e1800927.northwind; //your package

import java.io.File;
import java.io.FileWriter;

public class generateControllerandRepository {
    private static File file = new File("U:/northwind/src/main/java/fi/vamk/e1800927/northwind"); //your folder
    //Create the file
    ...
    public static void createRepository(String name){
        try {
            ...
            write.write("package fi.vamk.e1800927.northwind;\n\n");
